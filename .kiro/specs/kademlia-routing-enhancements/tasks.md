...
- [x] 1. Implement Replacement Cache for KBucket
  - [x] 1.1 Add replacementCache array and helper methods to KBucket
  ...
  - [x] 1.2 Implement replacement cache promotion on node failure
  ...
  - [x] 1.3 Write property tests for replacement cache (Properties 1-5)
...
- [x] 2. Checkpoint - Verify KBucket replacement cache
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Implement Self-Lookup on Node Join
  - [x] 3.1 Add self-lookup state and configuration to KademliaDHT
    - Add `selfLookupComplete`, `selfLookupRetries`, `maxSelfLookupRetries` properties
    - _Requirements: 2.5_

  - [x] 3.2 Implement performSelfLookup() method
  ...
  - [x] 3.3 Integrate self-lookup into start() method
    - Call `performSelfLookup()` after first bootstrap connection established
    - _Requirements: 2.2_

  - [x] 3.4 Write unit tests for self-lookup
  ...
  - [x] 3.5 Write property test for self-lookup (Property 6)
    - **Property 6: Self-Lookup Populates Routing Table** - all returned nodes added to routing table
    - **Validates: Requirements 2.3**

- [x] 4. Implement Proximity Routing
  - [x] 4.1 Implement selectNextHopWithProximity() method
  ...
  - [x] 4.2 Integrate proximity routing into findNode()
    - Use `selectNextHopWithProximity()` when selecting next hop candidates
    - _Requirements: 3.1, 3.2_

  - [x] 4.3 Write property tests for proximity routing (Properties 7-10)
...
- [x] 5. Checkpoint - Verify proximity routing
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement Recursive Routing Mode
  - [x] 6.1 Add recursive routing configuration to KademliaDHT
    - Add `routingMode` option (default: 'recursive')
    - Add `maxRecursiveHops` constant (20)
    - _Requirements: 4.7, 4.8_

  - [x] 6.2 Implement handleRecursiveFindNode() method
...
- [x] 8. Implement Proximity Neighbor Selection (PNS) in RoutingTable
  ...
  - [x] 8.6 Write unit tests for PNS configuration
...
- [x] 9. Implement Liveness Over Proximity Enforcement
  - [x] 9.1 Implement isNodeLive() method in RoutingTable
    - Check isAlive flag AND lastSeen within ping interval (5 minutes)
    - _Requirements: 6.1, 6.2, 6.3_

  - [x] 9.2 Implement shouldReplaceNode() method
  ...
  - [x] 9.3 Enhance addNode() with liveness priority
  ...
  - [x] 9.4 Write property tests for liveness enforcement (Properties 19-22)
...
- [x] 11. Integration wiring and final cleanup
  - [x] 11.1 Wire KBucket replacement cache into RoutingTable
  ...
  - [x] 11.2 Wire self-lookup and proximity routing together
